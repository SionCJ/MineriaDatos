...
public class EjemploJ48 {
    ...
    // Constructor
    public EjemploJ48(int numVecinos) {
    ...
    private Instances crearDatasetInicial() {
        ...
        FastVector clases = new FastVector();
        ...
        atributos.addElement(new Attribute("CLASE", clases));   // Atributo nominal
        atributos.addElement(new Attribute("TEXTO", (FastVector) null));  // Atributo String

        Instances dataset = new Instances("original", atributos, 100);
        dataset.setClass(dataset.attribute("CLASE")); // Otra forma equivalente: dataset.setClassIndex(0);
    ...
    public static void main(String[] args) {
        ...
        try {
            EjemploJ48 miClasificador = new EjemploJ48(Integer.parseInt(args[0]));
            System.out.println("Crear clasificador ... ");
            miClasificador.inicializar();
            System.out.println("Entrenar clasificador ... ");
            miClasificador.entrenarDirectorio(args[1]);
